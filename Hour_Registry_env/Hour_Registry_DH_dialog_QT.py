...
"}")
        ...
        self.pushButton_date.clicked.connect(DailyHours_edit_dialog.date_now)
        self.pushButton_end.clicked.connect(DailyHours_edit_dialog.end_now)
        self.pushButton_start.clicked.connect(DailyHours_edit_dialog.start_now)
        self.pushButton_cancel.clicked.connect(DailyHours_edit_dialog.close)
        self.pushButton_edit_table.clicked.connect(DailyHours_edit_dialog.edit_daily)
    ...
    def retranslateUi(self, DailyHours_edit_dialog):
        ...
        self.label_additional_information.setText(_translate("DailyHours_edit_dialog", "Additional information"))
